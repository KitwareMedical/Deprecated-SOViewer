...
Welcome to the \emph{SpatialObjects Viewers (SOViewer)
Software Guide}. This book has been updated for SOV 2.0 and later versions of
the SOViewer software.

SOV is an open-source, object-oriented software system for visualization of
.  Although it is large and complex, ITK is

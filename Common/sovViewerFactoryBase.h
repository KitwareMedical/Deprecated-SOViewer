/*=========================================================================
  ...
  Module:    $RCSfile: sovViewerFactoryBase.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __sovViewerFactoryBase_h
#define __sovViewerFactoryBase_h
...
namespace sov
{
/** \class ViewerFactoryBase
 * \brief Create instances of classes using an object factory.
 *
 * ViewerFactoryBase is used to create itk objects. The base class
 * ViewerFactoryBase contains a static method CreateInstance() that is
 * used to create itk objects from the list of registerd ViewerFactoryBase
...
class SOVCommon_EXPORT ViewerFactoryBase : public itk::Object
{
public:  
  /** Standard class typedefs. */
  typedef ViewerFactoryBase   Self;
  typedef itk::Object  Superclass;
  typedef itk::SmartPointer<Self>  Pointer;
  typedef itk::SmartPointer<const Self>  ConstPointer;
  
  /** Run-time type information (and related methods). */
  itkTypeMacro(ViewerFactoryBase, Object);

  /** Create and return an instance of the named itk object.
   * Each loaded ViewerFactoryBase will be asked in the order
   * the factory was in the ITK_AUTOLOAD_PATH.  After the
   * first factory returns the object no other factories are asked. */
  static itk::LightObject::Pointer CreateInstance(const char* itkclassname);
  ...
  static std::list<itk::LightObject::Pointer>
  ...
  static void RegisterFactory(ViewerFactoryBase* );

  /** Remove a factory from the list of registered factories. */
  static void UnRegisterFactory(ViewerFactoryBase*);
  ...
  static std::list<ViewerFactoryBase*> GetRegisteredFactories();

  /** All sub-classes of ViewerFactoryBase should must return the version of 
...
protected:
  ...
  void RegisterOverride(const char* classOverride,
      ...
      bool enableFlag,
      itk::CreateObjectFunctionBase* createFunction);
    
  /** This method is provioded by sub-classes of ViewerFactoryBase.
   * It should create the named itk object or return 0 if that object
   * is not supported by the factory implementation. */
  virtual itk::LightObject::Pointer CreateObject(const char* itkclassname );
  
  ViewerFactoryBase();
  virtual ~ViewerFactoryBase();

private:
  OverRideMap* m_OverrideMap;

  ViewerFactoryBase(const Self&); //purposely not implemented
  void operator=(const Self&); //purposely not implemented

  /** Initialize the static members of ViewerFactoryBase.   RegisterDefaults
   * is called here. */
  ...
  static std::list<ViewerFactoryBase*>* m_RegisteredFactories; 

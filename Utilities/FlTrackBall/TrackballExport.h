/*=========================================================================
  ...
  Module:    $RCSfile: TrackballExport.h,v $

  Language:  C++

  Date:      $Date: 2005-02-07 03:37:01 $
...
#ifndef __TrackballExport_h

#define __TrackballExport_h
...
# ifdef TrackBall_EXPORTS

#  define TrackBall_EXPORT __declspec(dllexport)

# else

#  define TrackBall_EXPORT __declspec(dllimport)

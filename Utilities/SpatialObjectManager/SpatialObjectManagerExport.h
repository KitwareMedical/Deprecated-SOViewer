/*=========================================================================
  ...
  Module:    $RCSfile: SpatialObjectManagerExport.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __SpatialObjectManagerExport_h
#define __SpatialObjectManagerExport_h
...
# ifdef SpatialObjectManager_EXPORTS
#  define SpatialObjectManager_EXPORT __declspec(dllexport)
# else
#  define SpatialObjectManager_EXPORT __declspec(dllimport)
# endif  /* SOViewer_EXPORT */
#else
/* unix needs nothing */
#define SpatialObjectManager_EXPORT 
#endif

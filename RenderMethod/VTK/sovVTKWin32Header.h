/*=========================================================================
  ...
  Module:    $RCSfile: sovVTKWin32Header.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __sovVTKWIN32Header_h
#define __sovVTKWIN32Header_h
...
# ifdef SOVVTKRenderMethod_EXPORTS
#  define SOVVTKRenderMethod_EXPORT __declspec(dllexport)
# else
#  define SOVVTKRenderMethod_EXPORT __declspec(dllimport)
# endif  /* ITKCommon_EXPORT */
#else
/* unix needs nothing */
#define SOVVTKRenderMethod_EXPORT 
#endif

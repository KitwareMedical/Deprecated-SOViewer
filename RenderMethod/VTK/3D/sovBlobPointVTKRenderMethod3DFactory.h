/*=========================================================================
  ...
  Program:   itkUNC
  Module:    $RCSfile: sovBlobPointVTKRenderMethod3DFactory.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef _BlobPointOpenVTKRenderMethodFactory_h
#define _BlobPointOpenVTKRenderMethodFactory_h
...
class SOVVTKRenderMethod_EXPORT BlobPointVTKRenderMethod3DFactory
...
public:
  ...
  /* Typedefs */
  typedef BlobPointVTKRenderMethod3DFactory       Self;
  ...
  itkTypeMacro( BlobPointVTKRenderMethod3DFactory, ViewerFactoryBase );
  ...
  {
    BlobPointVTKRenderMethod3DFactory::Pointer renderMethodFactory = BlobPointVTKRenderMethod3DFactory::New();
...
protected:
  ...
  /** Constructor */
  BlobPointVTKRenderMethod3DFactory( void );
...
private:
  ...
  BlobPointVTKRenderMethod3DFactory( const Self & );  //purposely not implemented 

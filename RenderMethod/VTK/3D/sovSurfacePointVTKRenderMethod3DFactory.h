/*=========================================================================
  ...
  Program:   itkUNC
  Module:    $RCSfile: sovSurfacePointVTKRenderMethod3DFactory.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef _SurfacePointOpenVTKRenderMethodFactory_h
#define _SurfacePointOpenVTKRenderMethodFactory_h
...
class SOVVTKRenderMethod_EXPORT SurfacePointVTKRenderMethod3DFactory
...
public:
  ...
  /* Typedefs */
  typedef SurfacePointVTKRenderMethod3DFactory      Self;
  ...
  itkTypeMacro( SurfacePointVTKRenderMethod3DFactory, ViewerFactoryBase );
  ...
  {
    SurfacePointVTKRenderMethod3DFactory::Pointer renderMethodFactory = SurfacePointVTKRenderMethod3DFactory::New();
...
protected:
  ...
  /** Constructor */
  SurfacePointVTKRenderMethod3DFactory( void );
...
private:
  ...
  SurfacePointVTKRenderMethod3DFactory( const Self & );  //purposely not implemented 

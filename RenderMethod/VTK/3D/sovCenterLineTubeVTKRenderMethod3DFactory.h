/*=========================================================================
  ...
  Program:   itkUNC
  Module:    $RCSfile: sovCenterLineTubeVTKRenderMethod3DFactory.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef _CenterLineTubeOpenVTKRenderMethodFactory_h
#define _CenterLineTubeOpenVTKRenderMethodFactory_h
...
class SOVVTKRenderMethod_EXPORT CenterLineTubeVTKRenderMethod3DFactory
...
public:
  ...
  /* Typedefs */
  typedef CenterLineTubeVTKRenderMethod3DFactory    Self;
  ...
  itkTypeMacro( CenterLineTubeVTKRenderMethod3DFactory, ViewerFactoryBase );
  ...
  {
    CenterLineTubeVTKRenderMethod3DFactory::Pointer renderMethodFactory = CenterLineTubeVTKRenderMethod3DFactory::New();
...
protected:
  ...
  /** Constructor */
  CenterLineTubeVTKRenderMethod3DFactory( void );
...
private:
  ...
  CenterLineTubeVTKRenderMethod3DFactory( const Self & );  //purposely not implemented 

/*=========================================================================
  ...
  Program:   itkUNC
  Module:    $RCSfile: sovSurfaceTubeVTKRenderMethodSlicerFactory.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef _SurfaceTubeVTKRenderMethodSlicerFactory_h
#define _SurfaceTubeVTKRenderMethodSlicerFactory_h
...
class SOVVTKRenderMethod_EXPORT SurfaceTubeVTKRenderMethodSlicerFactory
...
public:
  ...
  /* Typedefs */
  typedef SurfaceTubeVTKRenderMethodSlicerFactory       Self;
  ...
  itkTypeMacro( SurfaceTubeVTKRenderMethodSlicerFactory, ViewerFactoryBase );
  ...
  {
    SurfaceTubeVTKRenderMethodSlicerFactory::Pointer renderMethodFactory = SurfaceTubeVTKRenderMethodSlicerFactory::New();
...
protected:
  ...
  /** Constructor */
  SurfaceTubeVTKRenderMethodSlicerFactory( void );
...
private:
  ...
  SurfaceTubeVTKRenderMethodSlicerFactory( const Self & );  //purposely not implemented 

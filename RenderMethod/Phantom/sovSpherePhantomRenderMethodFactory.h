/*=========================================================================
  ...
  Program:   itkUNC
  Module:    $RCSfile: sovSpherePhantomRenderMethodFactory.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef _SpherePhantomRenderMethodFactory_h
#define _SpherePhantomRenderMethodFactory_h
...
class SpherePhantomRenderMethodFactory
...
public:
  ...
  /* Typedefs */
  typedef SpherePhantomRenderMethodFactory        Self;
  ...
  itkTypeMacro( SpherePhantomRenderMethodFactory, ViewerFactoryBase );
...
protected:
  ...
  /** Constructor */
  SpherePhantomRenderMethodFactory( void );
...
private:
  ...
  SpherePhantomRenderMethodFactory( const Self & );  //purposely not implemented 
...
#endif //_SpherePhantomRenderMethodFactory_h

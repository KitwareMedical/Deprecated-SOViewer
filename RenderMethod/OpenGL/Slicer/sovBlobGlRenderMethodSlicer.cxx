/*=========================================================================
  ...
  Program:   itkUNC
  Module:    $RCSfile: sovBlobGlRenderMethodSlicer.cxx,v $
  Language:  C++
...
=========================================================================*/
#include "sovBlobGlRenderMethodSlicer.h"
...
::draw( void )
{
  ...
  for(; currentObject!=lastObject; currentObject++)
  {
    ...
    memset(m_DisplaySlice, 0, m_SliceSizeX*m_SliceSizeY*4);
      ...
      BlobType::PointListType::const_iterator it = dynamic_cast<BlobType*>((*currentObject)->GetObject())->GetPoints().begin();

      while(it != dynamic_cast<BlobType*>((*currentObject)->GetObject())->GetPoints().end())
      {
...
::Update()
{
  ...
  this->draw();
  /*std::cout << "BlobGlRenderMethodSlicer::Updating " << std::endl;
  ObjectListType::iterator            currentObject,lastObject;
  currentObject = m_ObjectList->begin();
  lastObject = m_ObjectList->end();

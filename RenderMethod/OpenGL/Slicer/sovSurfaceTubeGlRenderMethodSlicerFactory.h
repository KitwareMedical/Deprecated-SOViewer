/*=========================================================================
  ...
  Program:   itkUNC
  Module:    $RCSfile: sovSurfaceTubeGlRenderMethodSlicerFactory.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef _sovSurfaceTubeGlRenderMethodSlicerFactory_h
#define _sovSurfaceTubeGlRenderMethodSlicerFactory_h
...
class SOVOpenGLRenderMethod_EXPORT SurfaceTubeGlRenderMethodSlicerFactory
...
public:
  ...
  /* Typedefs */
  typedef SurfaceTubeGlRenderMethodSlicerFactory   Self;
  ...
  itkTypeMacro( SurfaceTubeGlRenderMethodSlicerFactory, ViewerFactoryBase );
...
protected:
  ...
  /** Constructor */
  SurfaceTubeGlRenderMethodSlicerFactory( void );
...
private:
  ...
  SurfaceTubeGlRenderMethodSlicerFactory( const Self & );  //purposely not implemented 

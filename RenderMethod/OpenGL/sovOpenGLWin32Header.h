/*=========================================================================
  ...
  Module:    $RCSfile: sovOpenGLWin32Header.h,v $
  Language:  C++
  ...
  Portions of this code are covered under the OpenGL copyright.
  See OpenGLCopyright.txt or http://www.kitware.com/OpenGLCopyright.htm for details.
...
=========================================================================*/
#ifndef __sovOpenGLWIN32Header_h
#define __sovOpenGLWIN32Header_h
...
// SO_EXPORT can not be used
#define SOV_EXPORT
#if (defined(_WIN32) || defined(WIN32)) && !defined(SOVSTATIC) 
# ifdef SOVOpenGLRenderMethod_EXPORTS
#  define SOVOpenGLRenderMethod_EXPORT __declspec(dllexport)
# else
#  define SOVOpenGLRenderMethod_EXPORT __declspec(dllimport)
# endif  /* SO_EXPORT */
#else
/* unix needs nothing */
#define SOVOpenGLRenderMethod_EXPORT 
#endif

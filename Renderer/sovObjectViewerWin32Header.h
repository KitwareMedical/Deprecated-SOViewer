/*=========================================================================
  ...
  Module:    $RCSfile: sovObjectViewerWin32Header.h,v $
  Language:  C++
  Date:      $Date: 2005-01-28 17:00:37 $
...
=========================================================================*/
#ifndef __sovObjectViewerWIN32Header_h
#define __sovObjectViewerWIN32Header_h
...
# ifdef SOViewer_EXPORTS
#  define SOViewer_EXPORT __declspec(dllexport)
# else
#  define SOViewer_EXPORT __declspec(dllimport)
# endif  /* SOViewer_EXPORT */
#else
/* unix needs nothing */
#define SOViewer_EXPORT 
#endif
